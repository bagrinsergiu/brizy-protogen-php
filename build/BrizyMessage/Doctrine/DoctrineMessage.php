...
/**
 * Generated from protobuf message <code>brizyMessage.doctrine.DoctrineMessage</code>
 */
class DoctrineMessage extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.brizyMessage.doctrine.DoctrineMessage.DoctrineEventType event = 2;</code>
     */
    protected $event = 0;
    /**
     * entity id
    ...
    {
        GPBUtil::checkEnum($var, \BrizyMessage\Doctrine\DoctrineMessage\DoctrineEventType::class);
        $this->event = $var;
